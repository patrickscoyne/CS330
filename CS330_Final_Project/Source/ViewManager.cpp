...
{
	// If g_pCamera is NULL, return
	if (g_pCamera == NULL)
	{
		return;
	}

	// Increase or decrease camera speed with mouse scroll
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera moving up and down (Q for up, E for down)
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		...
		// Set camera to look at the scene straight on
...
void ViewManager::PrepareSceneView()
{
	...
	// define the current projection matrix (perspective or orthographic depending on keypress O or P).
