...
int main(int argc, char* argv[])
{
	...
	std::cout << "O - orthographic view\t" << "P - perspective view\n";
	std::cout << "Mouse Cursor - change camera angle\n";
	std::cout << "Mouse Scroll up - Decrease camera speed\n";
	std::cout << "Mouse Scroll down - Increase camera speed\n";
